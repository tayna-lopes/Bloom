...
namespace Bloom.DAO.Migrations
{
    ...
    [Migration("20210516233128_DoubleClassificacaoAvaliacao")]
    partial class DoubleClassificacaoAvaliacao
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bloom.BLL.Entities.Amizade", b =>
                {
                    b.HasOne("Bloom.BLL.Entities.Usuario", "Convidado")
                        .WithMany("Convites")
                        .HasForeignKey("ConvidadoId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Bloom.BLL.Entities.Usuario", "Convidante")
                        .WithMany("Convidados")
